...
INSERT INTO om_droit (om_droit, libelle, om_profil) VALUES (24, 'om_sig_extent', 2);
INSERT INTO om_droit (om_droit, libelle, om_profil) VALUES (13, 'om_sig_flux', 2);
INSERT INTO om_droit (om_droit, libelle, om_profil) VALUES (12, 'om_sig_map_flux', 2);
...
SELECT pg_catalog.setval('om_droit_seq', 25, false);
...
INSERT INTO om_parametre (om_parametre, libelle, valeur, om_collectivite) VALUES (3, 'web_agent', ' http://glenan.ville-arles.fr/web_service/rh/transfert_oci_json_accm.php?champ=nom', 1);
INSERT INTO om_parametre (om_parametre, libelle, valeur, om_collectivite) VALUES (4, 'nbm_widget_habilitation', '5', 1);
INSERT INTO om_parametre (om_parametre, libelle, valeur, om_collectivite) VALUES (5, 'nbm_widget_habilitation', '0', 1);
...
SELECT pg_catalog.setval('om_parametre_seq', 6, false);
...
--
-- Data for Name: om_widget; Type: TABLE DATA; Schema: openexemple; Owner: -
--

INSERT INTO om_widget (om_widget, libelle, lien, texte, type, script, arguments) 
VALUES (1, 'Habilitation non valide', '', '', 'file', 'habilitation_non_valide', '');


--
-- Name: om_widget_seq; Type: SEQUENCE SET; Schema: openexemple; Owner: -
--

SELECT pg_catalog.setval('om_widget_seq', 2, false);
